...
server_folder = Path("/", "Volumes", "Malonelab", "MaloneLab", "my_project")
```

It's best to avoid typing file paths with "/" or "\\" because this can differ between operating systems, but this is unavoidable with MaloneLab Server paths. 

For the rationale behind these recommendations, please check out ...
