...
Ensure you're either connected to the Yale network or using the VPN. Click "**Go**" at the top of your Mac screen. Then click "**Connect to Server...**".
...
The screen should be prompting you to enter your credentials. Please enter your username as
`yale\NetID`, replacing `NetID` with your actual NetID. Then enter your NetID password as usual.
...
If you have a `my_project` folder under `Research`, you can point to it in R like so:

```{r}
#| eval: false
# Option 1
server_folder <- "/Volumes/MaloneLab/Research/my_project"
...
Ensure you're either connected to the Yale network or using the VPN. Search for "**Run**" at Windows search bar and click to open the program.

![](images/windows_server3.png){width=80%}

Type in "\\\\corellia.environment.yale.edu\\malonelab" in the address bar and click "**OK**".
...
#| eval: false
# Option 1
server_folder <- "//corellia.environment.yale.edu/MaloneLab/Research/my_project"
...
:::callout-note
It's best to avoid typing file paths with "/" or "\\" because this can differ between operating systems, but this is unavoidable with MaloneLab Server paths (unless you set your working directory to a folder inside the server). If you must use slashes in your code, use the forward slash "/", as this will work on both Mac and Windows.

For more tips on file paths, please check out [File Paths](https://malone-disturbance-ecology-lab.github.io/Onboarding/file_paths.html).
:::